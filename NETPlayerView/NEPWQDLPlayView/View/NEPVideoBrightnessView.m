...
@interface NEPVideoBrightnessView ()

@property (nonatomic, strong) NSMutableArray *tips;

@end

@implementation NEPVideoBrightnessView
...
+ (instancetype)sharedBrightnessView {
    ...
    static NEPVideoBrightnessView *brightnessView;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        brightnessView = [[NEPVideoBrightnessView alloc] init];
...
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        
        {
            ...
            brightnessIcon.image = [UIImage imageNamed:NEPVideoPlayerImage(@"brightness")];
